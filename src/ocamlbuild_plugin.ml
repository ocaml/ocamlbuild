...
let pdep_multi = Command.pdep_multi
...
let pflag_multi = Ocamlbuild_pack.Flags.pflag_multi ?doc_param:None
...
let pflag_and_dep_multi = Ocamlbuild_pack.Flags.pflag_and_dep_multi ?doc_param:None
